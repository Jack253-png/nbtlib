...
public class ListTag<T extends Tag<?>> extends Tag<List<T>> implements Iterable<T>, Comparable<ListTag<T>> {
    ...
    public byte getID() {
        return NBTConstraints.LIST_TAG_ID;
    }
    ...
    public void addInt(int value) {
        addUnchecked(new IntegerTag(value));
    }
    ...
    public void addIntArray(int[] value) {
        addUnchecked(new IntegerArrayTag(value));
    }
    ...
    public ListTag<IntegerTag> asIntTagList() {
        return asTypedList(IntegerTag.class);
    }
    ...
    public ListTag<IntegerArrayTag> asIntArrayTagList() {
        return asTypedList(IntegerArrayTag.class);
    }
